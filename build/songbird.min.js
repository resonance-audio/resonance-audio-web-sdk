 ...
 * limitations under the License.
 */
const s=i(3),o=i(0);n.prototype.setAmbisonicOrder=function(t){this._ambisonicOrder=n.validateAmbisonicOrder(t),this.input.disconnect();for(let i=0;i<this._channelGain.length;i++)this._channelGain[i].disconnect();void 0!=this._merger&&this._merger.disconnect(),delete this._channelGain,delete this._merger;let e=(this._ambisonicOrder+1)*(this._ambisonicOrder+1);this._merger=this._context.createChannelMerger(e),this._channelGain=new Array(e);for(let i=0;i<e;i++)this._channelGain[i]=this._context.createGain(),this.input.connect(this._channelGain[i]),this._channelGain[i].connect(this._merger,0,i);this._merger.connect(this.output)},n.prototype.setDirection=function(t,e){(void 0==t||isNaN(t))&&(t=o.DEFAULT_AZIMUTH),(void 0==e||isNaN(e))&&(e=o.DEFAULT_ELEVATION),this._azimuth=t,this._elevation=e,(t=Math.round(t%360))<0&&(t+=360),e=Math.round(Math.min(90,Math.max(-90,e)))+90,this._channelGain[0].gain.value=s.MAX_RE_WEIGHTS[this._spreadIndex][0];for(let i=1;i<=this._ambisonicOrder;i++){let n=s.MAX_RE_WEIGHTS[this._spreadIndex][i];for(let o=-i;o<=i;o++){let r=i*i+i+o,a=i*(i+1)/2+Math.abs(o)-1,h=s.SPHERICAL_HARMONICS[1][e][a];if(0!=o){let e=s.SPHERICAL_HARMONICS_MAX_ORDER+o-1;o<0&&(e=s.SPHERICAL_HARMONICS_MAX_ORDER+o),h*=s.SPHERICAL_HARMONICS[0][t][e]}this._channelGain[r].gain.value=h*n}}},n.prototype.setSourceWidth=function(t){this._spreadIndex=Math.min(359,Math.max(0,Math.round(t))),this.setDirection(this._azimuth,this._elevation)},n.validateAmbisonicOrder=function(t){return isNaN(t)||void 0==t?(o.log("Error: Invalid ambisonic order",options.ambisonicOrder,"\nUsing ambisonicOrder=1 instead."),t=1):t<1?(o.log("Error: Unable to render ambisonic order",options.ambisonicOrder,"(Min order is 1)","\nUsing min order instead."),t=1):t>s.SPHERICAL_HARMONICS_MAX_ORDER&&(o.log("Error: Unable to render ambisonic order",options.ambisonicOrder,"(Max order is",s.SPHERICAL_HARMONICS_MAX_ORDER,")\nUsing max order instead."),options.ambisonicOrder=s.SPHERICAL_HARMONICS_MAX_ORDER),t},t.exports=n},function(t,e,i){"use strict";function n(t,e){void 0==e&&(e={}),void 0==e.ambisonicOrder&&(e.ambisonicOrder=r.DEFAULT_AMBISONIC_ORDER),void 0==e.position&&(e.position=r.DEFAULT_POSITION.slice()),void 0==e.forward&&(e.forward=r.DEFAULT_FORWARD.slice()),void 0==e.up&&(e.up=r.DEFAULT_UP.slice()),this.position=new Float32Array(3),this._tempMatrix3=new Float32Array(9),this._ambisonicOrder=o.validateAmbisonicOrder(e.ambisonicOrder),this._context=t,1==this._ambisonicOrder?this._renderer=s.Omnitone.createFOARenderer(t,{}):this._ambisonicOrder>1&&(this._renderer=s.Omnitone.createHOARenderer(t,{ambisonicOrder:this._ambisonicOrder})),this.input=t.createGain(),this.output=t.createGain(),this.ambisonicOutput=t.createGain();let i=this;this._renderer.initialize().then(function(){i.input.connect(i._renderer.input),i._ambisonicOrder>1?i._renderer._hoaRotator.output.connect(i.ambisonicOutput):i._renderer._foaRotator.output.connect(i.ambisonicOutput),i._renderer.output.connect(i.output)}),this.setOrientation(e.forward[0],e.forward[1],e.forward[2],e.up[0],e.up[1],e.up[2])}/**
 * @license
 * Copyright 2017 Google Inc. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 */
const s=i(0);n.prototype.computeAngle=function(t,e){let i=s.normalizeVector(t),n=s.normalizeVector(e),o=1;if(this._alpha>s.EPSILON_FLOAT){let t=i[0]*n[0]+i[1]*n[1]+i[2]*n[2];o=1-this._alpha+this._alpha*t,o=Math.pow(Math.abs(o),this._sharpness)}this._lowpass.frequency.value=.5*this._context.sampleRate*o},n.prototype.setPattern=function(t,e){this._alpha=Math.min(1,Math.max(0,t)),this._sharpness=Math.max(1,e),this.computeAngle([this._cosTheta*this._cosTheta,0,0],[1,0,0])},t.exports=n},function(t,e,i){"use strict";function n(t,e){void 0==e&&(e={}),void 0==e.minDistance&&(e.minDistance=s.DEFAULT_MIN_DISTANCE),void 0==e.maxDistance&&(e.maxDistance=s.DEFAULT_MAX_DISTANCE),void 0==e.rolloff&&(e.rolloff=s.DEFAULT_ATTENUATION_ROLLOFF),this.minDistance=e.minDistance,this.maxDistance=e.maxDistance,this.setRolloff(e.rolloff),this._gainNode=t.createGain(),this.setDistance(e.maxDistance),this.input=this._gainNode,this.output=this._gainNode}/**
 * @license
 * Copyright 2017 Google Inc. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 */
const s=i(0);n.prototype.setDistance=function(t){let e=1;if("logarithmic"==this._rolloff){if(t>this.maxDistance)e=0;else if(t>this.minDistance){let i=this.maxDistance-this.minDistance;if(i>s.EPSILON_FLOAT){let n=1/(i+1);e=(1/(t-this.minDistance+1)-n)/(1-n)}}}else if("linear"==this._rolloff)if(t>this.maxDistance)e=0;else if(t>this.minDistance){let i=this.maxDistance-this.minDistance;i>s.EPSILON_FLOAT&&(e=(this.maxDistance-t)/i)}this._gainNode.gain.value=e},n.prototype.setRolloff=function(t){let e=~s.ATTENUATION_ROLLOFFS.indexOf(t);void 0!=t&&e?t=t.toString().toLowerCase():(e||s.log('Invalid rolloff model ("'+t+'"). Using default: "'+s.DEFAULT_ATTENUATION_ROLLOFF+'".'),t=s.DEFAULT_ATTENUATION_ROLLOFF),this._rolloff=t},t.exports=n},function(t,e,i){"use strict";function n(t){let e={};for(let i in l.DEFAULT_ROOM_MATERIALS)l.DEFAULT_ROOM_MATERIALS.hasOwnProperty(i)&&(e[i]=l.ROOM_MATERIAL_COEFFICIENTS[l.DEFAULT_ROOM_MATERIALS[i]]);void 0==t&&(t={},Object.assign(t,l.DEFAULT_ROOM_MATERIALS));for(let i in l.DEFAULT_ROOM_MATERIALS)l.DEFAULT_ROOM_MATERIALS.hasOwnProperty(i)&&t.hasOwnProperty(i)?t[i]in l.ROOM_MATERIAL_COEFFICIENTS?e[i]=l.ROOM_MATERIAL_COEFFICIENTS[t[i]]:l.log('Material "'+t[i]+'" on wall "'+i+'" not found. Using "'+l.DEFAULT_ROOM_MATERIALS[i]+'".'):l.log('Wall "'+i+'" is not defined. Default used.');return e}function s(t){void 0==t&&(t={});for(let e in l.DEFAULT_ROOM_MATERIALS)t.hasOwnProperty(e)||(t[e]=l.ROOM_MATERIAL_COEFFICIENTS[l.DEFAULT_ROOM_MATERIALS[e]]);return t}function o(t){void 0==t&&(t={});for(let e in l.DEFAULT_ROOM_DIMENSIONS)t.hasOwnProperty(e)||(t[e]=l.DEFAULT_ROOM_DIMENSIONS[e]);return t}function r(t,e,i){let n=new Float32Array(l.NUMBER_REVERB_FREQUENCY_BANDS);t=o(t),e=s(e),void 0==i&&(i=l.DEFAULT_SPEED_OF_SOUND);let r=l.TWENTY_FOUR_LOG10/i,a=t.width*t.height*t.depth;if(a<l.ROOM_MIN_VOLUME)return n;let h=t.width*t.height,c=t.width*t.depth,_=t.depth*t.height,u=2*(h+c+_);for(let s=0;s<l.NUMBER_REVERB_FREQUENCY_BANDS;s++){let t=((e.left[s]+e.right[s])*h+(e.down[s]+e.up[s])*c+(e.front[s]+e.back[s])*_)/u;n[s]=l.ROOM_EYRING_CORRECTION_COEFFICIENT*r*a/(-u*Math.log(1-t)+4*l.ROOM_AIR_ABSORPTION_COEFFICIENTS[s]*a)}return n}function a(t){let e=[];for(let i in l.DEFAULT_REFLECTION_COEFFICIENTS)if(l.DEFAULT_REFLECTION_COEFFICIENTS.hasOwnProperty(i)){e[i]=0;for(let n=0;n<l.NUMBER_REFLECTION_AVERAGING_BANDS;n++){let s=n+l.ROOM_STARTING_AVERAGING_BAND;e[i]+=t[i][s]}e[i]/=l.NUMBER_REFLECTION_AVERAGING_BANDS,e[i]=Math.sqrt(1-e[i])}return e}function h(t,e){void 0==e&&(e={}),void 0==e.listenerPosition&&(e.listenerPosition=l.DEFAULT_POSITION.slice()),void 0==e.dimensions&&(e.dimensions={},Object.assign(e.dimensions,l.DEFAULT_ROOM_DIMENSIONS)),void 0==e.materials&&(e.materials={},Object.assign(e.materials,l.DEFAULT_ROOM_MATERIALS)),void 0==e.speedOfSound&&(e.speedOfSound=l.DEFAULT_SPEED_OF_SOUND),e.dimensions=o(e.dimensions);let i=n(e.materials),s=a(i),h=r(e.dimensions,i,e.speedOfSound);this.early=new _(t,{dimensions:e.dimensions,coefficients:s,speedOfSound:e.speedOfSound,listenerPosition:e.listenerPosition}),this.late=new c(t,{durations:h}),this.speedOfSound=e.speedOfSound,this.output=t.createGain(),this.early.output.connect(this.output),this._merger=t.createChannelMerger(4),this.late.output.connect(this._merger,0,0),this._merger.connect(this.output)}/**
 * @license
 * Copyright 2017 Google Inc. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 */
const c=i(8),_=i(9),l=i(0);h.prototype.setProperties=function(t,e){let i=n(e),s=r(t,i,this.speedOfSound);this.late.setDurations(s),this.early.speedOfSound=this.speedOfSound;let o=a(i);this.early.setRoomProperties(t,o)},h.prototype.setListenerPosition=function(t,e,i){this.early.speedOfSound=this.speedOfSound,this.early.setListenerPosition(t,e,i);let n=this.getDistanceOutsideRoom(t,e,i),s=1;n>l.EPSILON_FLOAT&&(s=1-n/l.LISTENER_MAX_OUTSIDE_ROOM_DISTANCE,s=Math.max(0,Math.min(1,s))),this.output.gain.value=s},h.prototype.getDistanceOutsideRoom=function(t,e,i){let n=Math.max(0,-this.early._halfDimensions.width-t,t-this.early._halfDimensions.width),s=Math.max(0,-this.early._halfDimensions.height-e,e-this.early._halfDimensions.height),o=Math.max(0,-this.early._halfDimensions.depth-i,i-this.early._halfDimensions.depth);return Math.sqrt(n*n+s*s+o*o)},t.exports=h},function(t,e,i){"use strict";function n(t,e){void 0==e&&(e={}),void 0==e.durations&&(e.durations=s.DEFAULT_REVERB_DURATIONS.slice()),void 0==e.predelay&&(e.predelay=s.DEFAULT_REVERB_PREDELAY),void 0==e.gain&&(e.gain=s.DEFAULT_REVERB_GAIN),void 0==e.bandwidth&&(e.bandwidth=s.DEFAULT_REVERB_BANDWIDTH),void 0==e.tailonset&&(e.tailonset=s.DEFAULT_REVERB_TAIL_ONSET);let i=e.predelay/1e3;this._bandwidthCoeff=e.bandwidth*s.LOG2_DIV2,this._tailonsetSamples=e.tailonset/1e3,this._context=t,this.input=t.createGain(),this._predelay=t.createDelay(i),this._convolver=t.createConvolver(),this.output=t.createGain(),this.output.gain.value=e.gain,this._convolver.normalize=!1,this.input.connect(this._predelay),this._predelay.connect(this._convolver),this._convolver.connect(this.output),this.setDurations(e.durations)}/**
 * @license
 * Copyright 2017 Google Inc. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 */
const s=i(0);n.prototype.setDurations=function(t){if(t.length!==s.NUMBER_REVERB_FREQUENCY_BANDS)return void s.log("Warning: invalid number of RT60 values provided to reverb.");let e=new Float32Array(s.NUMBER_REVERB_FREQUENCY_BANDS),i=this._context.sampleRate;for(let c=0;c<t.length;c++)t[c]=Math.max(0,Math.min(s.DEFAULT_REVERB_MAX_DURATION,t[c])),e[c]=Math.round(t[c]*i*s.DEFAULT_REVERB_DURATION_MULTIPLIER);let n=0;for(let s=0;s<e.length;s++)e[s]>n&&(n=e[s]);n<1&&(n=1);let o=this._context.createBuffer(1,n,i),r=o.getChannelData(0),a=new Float32Array(n);for(let s=0;s<n;s++)a[s]=2*Math.random()-1;for(let c=0;c<s.NUMBER_REVERB_FREQUENCY_BANDS;c++){let t=-s.LOG1000/e[c],n=s.TWO_PI*s.DEFAULT_REVERB_FREQUENCY_BANDS[c]/i,o=Math.sin(n),h=o*Math.sinh(this._bandwidthCoeff*n/o),_=1/(1+h),l=h*_,u=-2*Math.cos(n)*_,d=(1-h)*_,p=0,f=0;for(let i=0;i<e[c];i++){let e=a[i]*Math.exp(t*i)-u*p-d*f;r[i]+=l*(e-f),f=p,p=e}}let h=Math.round(this._tailonsetSamples);for(let c=0;c<Math.min(r.length,h);c++){let t=.5*(1-Math.cos(s.TWO_PI*c/(2*h-1)));r[c]*=t}this._convolver.buffer=o},t.exports=n},function(t,e,i){"use strict";function n(t,e){void 0==e&&(e={}),void 0==e.speedOfSound&&(e.speedOfSound=s.DEFAULT_SPEED_OF_SOUND),void 0==e.listenerPosition&&(e.listenerPosition=s.DEFAULT_POSITION.slice()),void 0==e.coefficients&&(e.coefficients={},Object.assign(e.coefficients,s.DEFAULT_REFLECTION_COEFFICIENTS)),this.speedOfSound=e.speedOfSound,this.input=t.createGain(),this.output=t.createGain(),this._lowpass=t.createBiquadFilter(),this._delays={},this._gains={},this._inverters={},this._merger=t.createChannelMerger(4);for(let i in s.DEFAULT_REFLECTION_COEFFICIENTS)s.DEFAULT_REFLECTION_COEFFICIENTS.hasOwnProperty(i)&&(this._delays[i]=t.createDelay(s.MAX_DURATION),this._gains[i]=t.createGain());this._inverters.right=t.createGain(),this._inverters.down=t.createGain(),this._inverters.back=t.createGain(),this._lowpass.type="lowpass",this._lowpass.frequency.value=s.DEFAULT_REFLECTION_CUTOFF_FREQUENCY,this._lowpass.Q.value=0;for(let i in s.DEFAULT_REFLECTION_COEFFICIENTS)s.DEFAULT_REFLECTION_COEFFICIENTS.hasOwnProperty(i)&&(this._delays[i].delayTime.value=0,this._gains[i].gain.value=0);this._inverters.right.gain.value=-1,this._inverters.down.gain.value=-1,this._inverters.back.gain.value=-1,this.input.connect(this._lowpass);for(let i in s.DEFAULT_REFLECTION_COEFFICIENTS)s.DEFAULT_REFLECTION_COEFFICIENTS.hasOwnProperty(i)&&(this._lowpass.connect(this._delays[i]),this._delays[i].connect(this._gains[i]),this._gains[i].connect(this._merger,0,0));this._gains.left.connect(this._merger,0,1),this._gains.right.connect(this._inverters.right),this._inverters.right.connect(this._merger,0,1),this._gains.up.connect(this._merger,0,2),this._gains.down.connect(this._inverters.down),this._inverters.down.connect(this._merger,0,2),this._gains.front.connect(this._merger,0,3),this._gains.back.connect(this._inverters.back),this._inverters.back.connect(this._merger,0,3),this._merger.connect(this.output),this._listenerPosition=e.listenerPosition,this.setRoomProperties(e.dimensions,e.coefficients)}/**
 * @license
 * Copyright 2017 Google Inc. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 */
const s=i(0);n.prototype.setListenerPosition=function(t,e,i){this._listenerPosition=[t,e,i];let n={left:s.DEFAULT_REFLECTION_MULTIPLIER*Math.max(0,this._halfDimensions.width+t)+s.DEFAULT_REFLECTION_MIN_DISTANCE,right:s.DEFAULT_REFLECTION_MULTIPLIER*Math.max(0,this._halfDimensions.width-t)+s.DEFAULT_REFLECTION_MIN_DISTANCE,front:s.DEFAULT_REFLECTION_MULTIPLIER*Math.max(0,this._halfDimensions.depth+i)+s.DEFAULT_REFLECTION_MIN_DISTANCE,back:s.DEFAULT_REFLECTION_MULTIPLIER*Math.max(0,this._halfDimensions.depth-i)+s.DEFAULT_REFLECTION_MIN_DISTANCE,down:s.DEFAULT_REFLECTION_MULTIPLIER*Math.max(0,this._halfDimensions.height+e)+s.DEFAULT_REFLECTION_MIN_DISTANCE,up:s.DEFAULT_REFLECTION_MULTIPLIER*Math.max(0,this._halfDimensions.height-e)+s.DEFAULT_REFLECTION_MIN_DISTANCE};for(let o in s.DEFAULT_REFLECTION_COEFFICIENTS)if(s.DEFAULT_REFLECTION_COEFFICIENTS.hasOwnProperty(o)){let t=n[o]/this.speedOfSound;this._delays[o].delayTime.value=t;let e=this._coefficients[o]/n[o];this._gains[o].gain.value=e}},n.prototype.setRoomProperties=function(t,e){void 0==t&&(t={},Object.assign(t,s.DEFAULT_ROOM_DIMENSIONS)),void 0==e&&(e={},Object.assign(e,s.DEFAULT_REFLECTION_COEFFICIENTS)),this._coefficients=e,this._halfDimensions={},this._halfDimensions.width=.5*t.width,this._halfDimensions.height=.5*t.height,this._halfDimensions.depth=.5*t.depth,this.setListenerPosition(this._listenerPosition[0],this._listenerPosition[1],this._listenerPosition[2])},t.exports=n},function(t,e,i){"use strict";/**
 * @license
 * Copyright 2017 Google Inc. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 */
e.Songbird=i(11),e.Songbird.Attenuation=i(6),e.Songbird.Directivity=i(5),e.Songbird.EarlyReflections=i(9),e.Songbird.Encoder=i(1),e.Songbird.LateReflections=i(8),e.Songbird.Listener=i(2),e.Songbird.Room=i(7),e.Songbird.Source=i(4),e.Songbird.Tables=i(3),e.Songbird.Utils=i(0),e.Songbird.Version=i(13)},function(t,e,i){"use strict";function n(t,e){void 0==e&&(e={}),void 0==e.ambisonicOrder&&(e.ambisonicOrder=h.DEFAULT_AMBISONIC_ORDER),void 0==e.listenerPosition&&(e.listenerPosition=h.DEFAULT_POSITION.slice()),void 0==e.listenerForward&&(e.listenerForward=h.DEFAULT_FORWARD.slice()),void 0==e.listenerUp&&(e.listenerUp=h.DEFAULT_UP.slice()),void 0==e.dimensions&&(e.dimensions={},Object.assign(e.dimensions,h.DEFAULT_ROOM_DIMENSIONS)),void 0==e.materials&&(e.materials={},Object.assign(e.materials,h.DEFAULT_ROOM_MATERIALS)),void 0==e.speedOfSound&&(e.speedOfSound=h.DEFAULT_SPEED_OF_SOUND),this._ambisonicOrder=a.validateAmbisonicOrder(e.ambisonicOrder),this._sources=[],this._room=new r(t,{listenerPosition:e.listenerPosition,dimensions:e.dimensions,materials:e.materials,speedOfSound:e.speedOfSound}),this._listener=new s(t,{ambisonicOrder:e.ambisonicOrder,position:e.listenerPosition,forward:e.listenerForward,up:e.listenerUp}),this._context=t,this.output=t.createGain(),this.ambisonicOutput=t.createGain(),this.ambisonicInput=this._listener.input,this._room.output.connect(this._listener.input),this._listener.output.connect(this.output),this._listener.ambisonicOutput.connect(this.ambisonicOutput)}/**
 * @license
 * Copyright 2017 Google Inc. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
